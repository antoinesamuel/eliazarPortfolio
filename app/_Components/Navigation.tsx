  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-6 right-6 z-50 w-16 h-16 bg-white rounded-full border border-gray-200 flex flex-col items-center justify-center gap-1.5 shadow-md active:scale-95 transition-transform"
      >
        <span
      ...
      >
        ...
        <div className="flex items-center font-nohemi-medium justify-between text-[1.25rem] pt-6 border-t border-gray-100 mobile-nav-item">
          <a
